...
function changeView() {
    document.getElementById("maincontent").classList.toggle("panelview");
    document.getElementById("maincontent").classList.toggle("listview");
}

function fadeoutList() {
    var list = document.getElementsByClass("ul")[0];
...
function showList(text) {
    ...
    var list = document.getElementsByClass( "ul")[0];
    list.classList.toggle( "active" );
    list.addEventListener( "transitionend", fadeoutList );
    setTimeout(function() {
        list.classList.toggle( "active" );
    }, 3500);
}